...
const ViewSales = () => {
  ...
  return (
    <div className='md:w-[80%] md:mx-auto'>
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content px-4">
          <div className="flex items-center justify-between ">
            ...
            <h2 className='text-xl w-full text-center md:text-start'>Dispatch Records</h2>
            {/* search bar */}
            <form action="" className='hidden md:flex items-center w-1/2'>
              <input type="text" placeholder="Search dispatch records" className="input input-bordered rounded-full h-10 lg:w-full" />
          ...
          <form action="" className='flex md:hidden items-center w-full mt-4'>
            <input type="text" placeholder="Search dispatch records" className="input input-bordered rounded-full h-10 w-full" />
            <button type="submit" className='serch p-2 bg-blue-500 text-white rounded-md ms-2'>
              <MagnifyingGlassIcon className='w-6 h-6' />
            </button>
          </form>
          ...
          {/* table start */}
          {salesList.length <= 0 ? <div className='text-sm px-2 text-center'>No Dispatch Records Found</div>
            :
                    ...
                    return (
                      <tr className="hover" key={inx}>
                        ...
                        <td><button
                          ...
                          className='btn btn-sm btn-primary '>Download Report</button>
                          <button
      ...
      <ModalInvoice id="invoice_modal" title="Download Dispatch Report" InvoiceDetails={printInvoiceData} />
      <Toaster />
    </div>
  )
}
